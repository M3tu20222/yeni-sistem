      ...
      <Card className="w-full max-w-md border-2 border-neon-purple bg-slate-900/50 shadow-[0_0_15px_rgba(157,0,255,0.5)] backdrop-blur-sm">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-neon-yellow">
                Şifre
              </Label>
              <Input
                id="password"
            ...
            <div className="space-y-2">
              <Label htmlFor="subject" className="text-neon-blue">
                Ders
              </Label>
              <Select {...register("subject")}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Sosyal Bilgiler">
                    Sosyal Bilgiler
                  </SelectItem>
                  <SelectItem value="Din Kültürü">Din Kültürü</SelectItem>
                  <SelectItem value="Fen ve Teknoloji">
                    Fen ve Teknoloji
                  </SelectItem>
            ...
            <div className="space-y-2">
              <Label htmlFor="role" className="text-neon-yellow">
                Rol
              </Label>
            ...
            <Button
              type="submit"
              className="w-full bg-neon-purple hover:bg-neon-pink text-white transition-all duration-300 shadow-lg hover:shadow-neon-pink/50"
            >
              Kayıt Ol
            </Button>
          </form>
